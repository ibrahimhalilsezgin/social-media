<script lang="ts">
  ...
  async function shareButton() {
    ...
    try {
      ...
      // Başarılı paylaşımdan sonra formu temizle
      description = "";
      removeImage();
...
<div class="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-6">
